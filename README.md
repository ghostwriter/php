...
> **Supported versions: [`8.6`](#-use-php-86-image-in-dockerfile), [`8.5`](#-use-php-85-image-in-dockerfile), [`8.4`](#-use-php-84-image-in-dockerfile), [`8.3`](#-use-php-83-image-in-dockerfile), [`8.2`](#-use-php-82-image-in-dockerfile), [`8.1`](#-use-php-81-image-in-dockerfile), [`8.0`](#-use-php-80-image-in-dockerfile), [`7.4`](#-use-php-74-image-in-dockerfile)**

## PHP 8.6

#### ![Code](resource/icons/code.svg) Use `PHP 8.6` image in Dockerfile

**CLI with code coverage**
```Dockerfile
FROM ghcr.io/ghostwriter/php:8.6
```
**CLI**
```Dockerfile
FROM ghcr.io/ghostwriter/php:8.6-cli
```
**FPM**
```Dockerfile
FROM ghcr.io/ghostwriter/php:8.6-fpm
```
**ZTS**
```Dockerfile
FROM ghcr.io/ghostwriter/php:8.6-zts
```

#### ![Terminal](resource/icons/terminal.svg) Pull & Run `PHP 8.6` image from the command line

**CLI with code coverage**
```sh
docker pull ghcr.io/ghostwriter/php:8.6
docker run -it --rm -v $PWD:/opt/app -w /opt/app ghcr.io/ghostwriter/php:8.6 php -v
```
**CLI**
```sh
docker pull ghcr.io/ghostwriter/php:8.6-cli
docker run -it --rm -v $PWD:/opt/app -w /opt/app ghcr.io/ghostwriter/php:8.6-cli php -v
```
**FPM**
```sh
docker pull ghcr.io/ghostwriter/php:8.6-fpm
docker run -it --rm -v $PWD:/opt/app -w /opt/app ghcr.io/ghostwriter/php:8.6-fpm php -v
```
**ZTS**
```sh
docker pull ghcr.io/ghostwriter/php:8.6-zts
docker run -it --rm -v $PWD:/opt/app -w /opt/app ghcr.io/ghostwriter/php:8.6-zts php -v
```
